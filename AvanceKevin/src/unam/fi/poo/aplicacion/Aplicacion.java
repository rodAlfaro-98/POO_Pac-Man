...
import unam.fi.poo.vista.ControlsGrid;
...
public class Aplicacion extends Application{
	...
	public Stage window;
	public Scene menuScene , creditsScene, scoreScene, highScoreScene, controlsScene;
	...
	private ControlsGrid controlsGrid;
	...
	*/
	public Aplicacion(){
		...
		this.controlsGrid = new ControlsGrid();
		...
		this.controlsScene = new Scene( controlsGrid, WIDTH, HEIGHT );
	...
	*/
	...
	/**
	* @brief Getter del atributo controlsGrid
	* @return Un objeto de tipo ControlsGrid que contiene a controlsGrid
	*/
	public ControlsGrid getControlsGrid(){
		return this.controlsGrid;
	}
	...
	*/
	...
	/**
	* @brief Getter del atributo controlsScene
	* @return Un objeto de tipo ControlsScene que contiene a controlsScene
	*/
	public Scene getControlsScene(){
