...
public class ScoreGrid extends GridPane {
	...
	*/
	public void getBestFive(){
		...
		//Generamos un mapa <Integer,String> para poder acceder a los usuarios a partir de su puntaje
		...
		//Función estática del objeto Collections (Padre de las estructuras) para ordenar
